...
import { ReactComponent as BalloonConnection } from "../../assets/icons/BalloonConnection.svg";
...
import { SERVICES, MEMBERS } from "../../assets/copy/home.js";
...
const Home = () => {
  return (
    <>
      <section className="hero hero--wavy">
        <div className="hero__image-container">
          <BalloonConnection className="hero__image" />
        </div>
        ...
        <div class="custom-shape-divider-bottom-1711915537">
          <svg
            data-name="Layer 1"
      ...
      <section className="services">
        ...
        <div class="custom-shape-divider-bottom-1711916057">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
      ...
      <section className="members">
        ...
        <div class="custom-shape-divider-bottom-1711916440">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
